...
@router.post("/auditar", response_model=AuditoriaEmergenciasResponse, status_code=200)
async def auditar_atencion_emergencias(data: AuditoriaEmergenciasRequest):
    """
    Audita un registro individual de atención de emergencias.
    ...
    (sector 3 = emergencias) y los evalúa contra guías internacionales
    con criterios de alta complejidad y tiempos estrictos.
    """
    try:
